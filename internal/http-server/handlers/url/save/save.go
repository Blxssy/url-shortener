...
import (
	"errors"
	"github.com/Blxssy/url-shortener/internal/lib/api/response"
	"github.com/Blxssy/url-shortener/internal/lib/logger/sl"
	"github.com/Blxssy/url-shortener/internal/lib/random"
	"github.com/Blxssy/url-shortener/internal/storage"
...
func New(log *slog.Logger, urlSaver URLSaver) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		const op = "handlers.save.url.New"
